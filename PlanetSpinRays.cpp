...
GLfloat rot = 1.0;
GLfloat eyex = 0.0, eyey = 0.0, eyez = -4.7;
...
void display(void)
{
	...
	// Step 9:
	// draw the sun using the appropriate function call
	DrawSun();

	// Step 10:
	// draw the satellite using the appropriate function call
	DrawSatellite();

	// Step 11:
	// draw the first moon using the appropriate function call
	DrawMoon();

	// Step 12:
	// draw the second moon using the appropriate function call
	DrawSecondMoon();
